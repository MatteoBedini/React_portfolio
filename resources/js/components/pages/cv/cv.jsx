        ...
        <>
            <div className="presentazione-cus">
                ...
                <Section
                    ...
                    content={
                        <div>
                            ...
                            <i className="fa-solid fa-volleyball pe-4"></i><span>La sera mi trasformo in un giocatore e allenatore professionale di pallavolo dove ad oggi mi trovo impegnato in più di 20 ore settimanali.
                ...
                <div className="arrow bounce">
                    <a className="" href="#formazione"><i className="fa-solid fa-arrow-down fa-2x"></i></a>
                </div>
            </div>
            
            <Header title="Formazione"  id="formazione"  />
            <Section
